...
module "app1_ccg_admin_iam" {
  source           = "../modules/iam/projects-iam"
  project_id       = trimprefix(module.app1_ccg_project.project_id, "projects/")
  admin_roles      = local.admin_roles
  admin_group_name = var.admin_group_name
}

module "app1_ccg_developer_iam" {
  source               = "../modules/iam/projects-iam"
  project_id           = trimprefix(module.app1_ccg_project.project_id, "projects/")
