...
module "app1_cis_admin_iam" {
  source           = "../modules/iam/projects-iam"
  project_id       = trimprefix(module.app1_cis_project.project_id, "projects/")
  admin_roles      = local.admin_roles
  admin_group_name = var.admin_group_name
}

module "app1_cis_developer_iam" {
  source               = "../modules/iam/projects-iam"
  project_id           = trimprefix(module.app1_cis_project.project_id, "projects/")
